...
Shell::run()
{
    ...
    */
    ...
    filesystem.cp("f2","f4");
    std::cout << "cp(f1,..)..." << std::endl; //DENNA ORSAKAR FEL
    filesystem.cp("f1","..");
    std::cout << "cp(f2,/d1)..." << std::endl; // DENNA ORSAKAR FEL
    filesystem.cp("f2","/d1");
    std::cout << "mv(f3,..)..." << std::endl; //DENNA ORSAKAR FEL
    filesystem.mv("f3","..");
    std::cout << "mv(f4,/d1)..." << std::endl; //DENNA ORSAKAR FEL
    filesystem.mv("f4","/d1");
    std::cout << "Expected output:" << std::endl;
    std::cout << "/d1/d2" << std::endl;
    std::cout << "name\t type\t size" << std::endl;
